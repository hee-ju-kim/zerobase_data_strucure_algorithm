...
class MyDeque {
    ...
    public void addMiddle(int data) {
        ...
        int ele = this.rear - this.front;
        if (ele < 0) {
            ele = this.arr.length + ele;
        }

        int mid = (this.rear - ele / 2 + this.arr.length) % this.arr.length + 1;

        int start =  (this.rear + 1) % this.arr.length;
        int end = (this.rear - ele / 2 + this.arr.length ) % this.arr.length;
